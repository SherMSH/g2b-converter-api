...
type Body struct {
	SoapRq SoapRq `xml:"ChangeCMSAbonentRq" json:"ChangeCMSAbonentRq"`
}
...
// SoapRq соответствует элементу ChangeCMSAbonentRq
type SoapRq struct {
...
type Row struct {
	...
	TestMessage   string `xml:"TestMessage" json:"test_message"`
	PrevChannel   string `xml:"PrevChannel" json:"prev_channel"`
	PrevAddress   string `xml:"PrevAddress" json:"prev_address"`
}
